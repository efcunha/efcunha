...
Tecnologias conhecidas: Kubernetes, Docker, Microserviços, CI/CD (GitLab,Jenkins,SonarQube,Sentry,Jfrog,Harbor), Git, JavaScript, TypeScript, NodeJS, ReactJS, React, AngularJS, Express, MongoDB, APIs Restfull e etc...
